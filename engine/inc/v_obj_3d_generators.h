...
#ifndef VECTOR_PRIMITIVES_H
#define VECTOR_PRIMITIVES_H
...
OBJ_3D * obj_3d_uv_mesh(MESH_TYPE type, SURFACE_WRAP wrap_type, INT uv, INT vv, INT ut, INT vt);
